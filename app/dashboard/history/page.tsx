...
<div className='m-5 p-5 border rounded-lg bg-white'>
    ...
    {HistoryList.map((item:HISTORY, index:number) => (
        <>
            <div className='grid grid-cols-1 md:grid-cols-7 my-5 py-3 px-3 gap-3'>
                ...
                <h2 className='md:text-left'>{item.createdAt}</h2>
                <h2 className='md:text-left'>{item?.aiResponse.length}</h2>
